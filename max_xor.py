"""Treść zadania:
Mając tablicę liczb całkowitych, znajdź maksymalny XOR dowolnych dwóch elementów.

Wejście:
Tablica elementów o typie integer.

Wyjście:
Maksymalny XOR dwóch elementów tablicy."""
